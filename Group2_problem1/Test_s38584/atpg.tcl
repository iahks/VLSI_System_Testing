...
## Read target netlist
read_netlist ./Netlist/s38584_dft.v

## Specify top module
run_build_model s38584

## Run DRC
run_drc ./Netlist/s38584_dft.spf
...
## Write fault list
write_faults ./Netlist/s38584_stuck_full.fault -all -replace

## write generated test pattern
write_patterns ./Netlist/s38584_stuck_full.stil -format STIL -replace
