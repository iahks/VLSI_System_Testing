...
## Read target netlist
read_netlist ./Netlist/s400_dft.v

## Specify top module
run_build_model s400

## Run DRC
run_drc ./Netlist/s400_dft.spf
...
## Write fault list
write_faults ./Netlist/s400_stuck_full.fault -all -replace

## write generated test pattern
write_patterns ./Netlist/s400_stuck_full.stil -format STIL -replace
