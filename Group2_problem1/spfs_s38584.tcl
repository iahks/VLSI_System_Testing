...
## Read target netlist
read_netlist ./Test_s38584/Netlist/s38584_dft.v

## Specify top module
run_build_model s38584

## Run DRC
run_drc ./Test_s38584/Netlist/s38584_dft.spf
...
set file [open "./Test_s38584/Netlist/s38584_stuck_full.stil" r]
...
set_patterns -external ./Test_s38584/Netlist/s38584_stuck_full.stil

## make a file to store the distribution of the numbers of detected faults
set filename "./pat_fault_s38584.txt"
...
set file_id [open "./pat_fault_s38584.txt" a]
...
for {set num 0} {$num < $length} {set num [expr {$num + 1}]} {
    ...
    run_fault_sim -ndetects 1 -first_pattern $num -last_pattern $num >> faultSimResult_s38584.txt
    report_faults -class { DS } >> ./pat_fault_s38584.txt
}

file delete faultSimResult_s38584.txt
