...
## Read target netlist
read_netlist ./Test_s400/Netlist/s400_dft.v

## Specify top module
run_build_model s400

## Run DRC
run_drc ./Test_s400/Netlist/s400_dft.spf
...
set file [open "./Test_s400/Netlist/s400_stuck_full.stil" r]
...
set_patterns -external ./Test_s400/Netlist/s400_stuck_full.stil

## make a file to store the distribution of the numbers of detected faults
set filename "./pat_fault_s400.txt"
...
set file_id [open "./pat_fault_s400.txt" a]
...
for {set num 0} {$num < $length} {set num [expr {$num + 1}]} {
    ...
    report_faults -class { DS } >> ./pat_fault_s400.txt
}
